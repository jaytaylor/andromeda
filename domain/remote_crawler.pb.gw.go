...
func request_RemoteCrawlerService_Receive_0(ctx context.Context, marshaler runtime.Marshaler, client RemoteCrawlerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CrawlResult
	var metadata runtime.ServerMetadata
...
func RegisterRemoteCrawlerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RemoteCrawlerServiceClient) error {
	...
	mux.Handle("POST", pattern_RemoteCrawlerService_Receive_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_RemoteCrawlerService_Receive_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_RemoteCrawlerService_Receive_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_RemoteCrawlerService_Receive_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "receive"}, ""))
...
var (
	...
	forward_RemoteCrawlerService_Receive_0 = runtime.ForwardResponseMessage
