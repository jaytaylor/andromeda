...
func (*PendingReferences) Descriptor() ([]byte, []int) {
	return fileDescriptorPendingReferences, []int{0}
}
...
func init() { proto.RegisterFile("pending_references.proto", fileDescriptorPendingReferences) }

var fileDescriptorPendingReferences = []byte{
