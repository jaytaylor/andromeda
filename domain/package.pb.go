...
type Package struct {
	...
	ImportedBy  []string         `protobuf:"bytes,9,rep,name=imported_by,json=importedBy" json:"imported_by,omitempty"`
...
func (m *Package) GetDocsURL() string {
	if m != nil {
		return m.DocsURL
	}
	return ""
...
func (m *Package) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DocsURL) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintPackage(dAtA, i, uint64(len(m.DocsURL)))
		i += copy(dAtA[i:], m.DocsURL)
	}
	if len(m.Owner) > 0 {
		dAtA[i] = 0x32
		i++
...
var fileDescriptorPackage = []byte{
	...
	,
}
