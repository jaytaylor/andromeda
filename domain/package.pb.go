...
func (*Package) Descriptor() ([]byte, []int) {
	return fileDescriptor_package_edeafaacc4d24c0d, []int{0}
}
...
func (*PackageReferences) Descriptor() ([]byte, []int) {
	return fileDescriptor_package_edeafaacc4d24c0d, []int{1}
}
...
func (m *PackageReferences) GetRoot() string {
	if m != nil {
		return m.Root
	}
	return ""
...
func (*PackageReference) Descriptor() ([]byte, []int) {
	return fileDescriptor_package_edeafaacc4d24c0d, []int{2}
}
...
func (*PackageCrawl) Descriptor() ([]byte, []int) {
	return fileDescriptor_package_edeafaacc4d24c0d, []int{3}
}
...
func (*PackageSnapshot) Descriptor() ([]byte, []int) {
	return fileDescriptor_package_edeafaacc4d24c0d, []int{4}
}
...
func (*SubPackage) Descriptor() ([]byte, []int) {
	return fileDescriptor_package_edeafaacc4d24c0d, []int{5}
}
...
func (m *PackageReferences) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Root) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintPackage(dAtA, i, uint64(len(m.Root)))
...
func init() { proto.RegisterFile("package.proto", fileDescriptor_package_edeafaacc4d24c0d) }

var fileDescriptor_package_edeafaacc4d24c0d = []byte{
	// 1163 bytes of a gzipped FileDescriptorProto
	,
}
