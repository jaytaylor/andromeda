...
type CrawlResult struct {
	...
	ImportedResources map[string]*PackageReference `protobuf:"bytes,2,rep,name=imported_resources,json=importedResources" json:"imported_resources,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
...
func (m *CrawlResult) GetImportedResources() map[string]*PackageReference {
	if m != nil {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.ImportedResources == nil {
				m.ImportedResources = make(map[string]*PackageReference)
			}
			var mapkey string
			var mapvalue *PackageReference
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
var fileDescriptorRemoteCrawler = []byte{
	...
	,
}
