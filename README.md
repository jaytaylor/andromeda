...
protoc-gen-gorm compatibility is tightly coupled to certain versions of various packages, so it's necessary to use [dep](https://github.com/golang/dep) to fetch all vendored dependencies.
